        ...
        <div className={styles.body}>
            ...
            <div className={styles.containerContant}>
                ...
                <p>Esta Política de Privacidade descreve como coletamos, usamos e protegemos as informações pessoais
                    fornecidas por você ao utilizar nosso CRM focado em corretores, o Corretor Lab.</p>
                ...
                <ul className={styles.integracoesList}>
                    <li className={styles.integracoesList}>Informações de eventos de calendário, como título, data, hora e participantes, para agendar reuniões
                        em nome dos usuários.
                    </li>
                    <li className={styles.integracoesList}>Integração com o Google Meet para gerar links de reuniões automaticamente.</li>
                </ul>
                ...
                <p>Utilizamos cookies para melhorar sua experiência no nosso site e entender como você interage com o
                    Corretor Lab. Você pode desativar os cookies através das configurações do seu navegador, mas isso pode afetar
                    algumas funcionalidades da plataforma.</p>

                <h2>Seus Direitos</h2>
                <p>Você tem o direito de acessar, corrigir ou excluir suas informações pessoais a qualquer momento. Isso inclui a
                    revogação de acesso aos serviços do Google, como Google Calendar e Google Meet. Entre em
